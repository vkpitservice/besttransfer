    ...
    <TouchableOpacity onPress={onPress} style={styles.root}>
      ...
      <View style={styles.imageTextContainer}>
        {type.toLowerCase() == 'success' ?
          <View style={{ flexDirection: 'row', borderBottomWidth: 1,borderBottomColor:ColorSheet.TransactionInprocess, padding: 5, backgroundColor: ColorSheet.TransactionSuccess, borderTopLeftRadius: 10, borderTopRightRadius: 10 }}>
          ...
          type.toLowerCase() == "failed" ?
            <View style={{ flexDirection: 'row', borderBottomWidth: 1,borderBottomColor:ColorSheet.TransactionInprocess, padding: 5, backgroundColor: ColorSheet.TransactionFailed, borderTopLeftRadius: 10, borderTopRightRadius: 10 }}>
            ...
            type.toLowerCase() == "review" ?
              <View style={{ flexDirection: 'row', borderBottomWidth: 1,borderBottomColor:ColorSheet.TransactionInprocess, padding: 5, backgroundColor: ColorSheet.TransactionReview, borderTopLeftRadius: 10, borderTopRightRadius: 10 }}>
              ...
              :
              <View style={{ flexDirection: 'row', borderBottomWidth: 1,borderBottomColor:ColorSheet.TransactionInprocess, padding: 5, backgroundColor: ColorSheet.TransactionInprocess, borderTopLeftRadius: 10, borderTopRightRadius: 10 }}>
