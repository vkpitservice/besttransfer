...
const WalletSuccessTransaction = ({ navigation, route }) => {
    const { url, enteredamount, fees, exchangeRate, fromCurrency, toCurrency,totalAmount } = route.params;
...
export default WalletSuccessTransaction;